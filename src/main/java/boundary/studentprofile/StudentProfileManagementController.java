 ...
 * @author Raymond
 */
public class StudentProfileManagementController implements Initializable {
    ...
    public Experience showExperienceDialog() throws IOException {
        ...
        ExperienceDetailController controller = fxmlLoader.getController();
    ...
    public Qualification showQualificationDialog() throws IOException {
        ...
        Node node = fxmlLoader.load();
        QualificationDetailController controller = fxmlLoader.getController();
    ...
    public Skill showSkillDialog() throws IOException {
        ...
        Node node = fxmlLoader.load();
        SkillDetailController controller = fxmlLoader.getController();
